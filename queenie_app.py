...
<style>
    ...
    /* 未選圓圈：強制深灰邊框 */
    [data-testid="stRadio"] label input[type="radio"]:not(:checked),
    .stRadio label input[type="radio"]:not(:checked),
    ...
    /* 已選圓圈：深藍實心 + 白點 */
    [data-testid="stRadio"] label input[type="radio"]:checked,
    .stRadio label input[type="radio"]:checked,
    div[role="radiogroup"] input[type="radio"]:checked {
        appearance: none !important;
        -webkit-appearance: none !important;
        border: 2.5px solid #1e3a5f !important;
        border-radius: 50% !important;
    ...
    # ===== 階段 2：作答中 =====
        ...
        for q in questions:
            ...
            if q_type == "multiple_choice":
                ...
                st.caption("✏️ 此題為多選題，請選出所有正確答案｜答對 +2分・漏選 +1分・答錯 0分")
            else:
