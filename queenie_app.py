...
# 頂部資訊欄：純 Streamlit columns，CSS 染色背景
st.markdown("""
<style>
/* 橫條三欄背景 */
div[data-testid="stHorizontalBlock"]:has(div.top-bar-col) {
...
_c1, _c2, _c3 = st.columns([3, 4, 3])
with _c1:
    st.markdown(f"""<div class="top-bar-col" style="color:white;">
...
with _c2:
    st.markdown(f"""<div class="top-bar-col" style="text-align:center;">
...
with _c3:
    st.markdown(f"""<div class="top-bar-col" style="text-align:right;">
...
st.markdown(f"""
<div style="background:#1e3a5f; border-radius:0 0 8px 8px; padding:6px 20px 14px; margin-top:-4px; margin-bottom:16px;">
    <div style="background:rgba(255,255,255,0.25); border-radius:99px; height:5px;">
        <div style="width:{_prog}%; height:100%; background:#60a5fa; border-radius:99px;"></div>
    </div>
</div>
""", unsafe_allow_html=True)
# ============================================================
