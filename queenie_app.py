...
with st.sidebar:
    ...
    # 側邊欄底部：登出按鍵
    st.divider()
    if st.button("🚪 登出", use_container_width=True, help="登出後需重新輸入密碼"):
        # 清除所有 session state
...
st.markdown(f"""
<div style="background:#1e3a5f; color:white; padding:20px 24px 14px; border-radius:8px; margin-bottom:14px; min-height:90px; overflow:visible; box-sizing:border-box;">
    <table style="width:100%; border-collapse:collapse; color:white; table-layout:fixed;">
        <tr style="vertical-align:top;">
            <td style="width:30%; padding:0 0 10px 0;">
                <p style="font-size:13px; color:rgba(255,255,255,0.8); margin:0 0 4px 0; line-height:1.4;">距 {EXAM_YEAR} 學測</p>
                <p style="font-size:34px; font-weight:700; margin:0; line-height:1.1;">{phase_info['days_left']} <span style="font-size:14px; font-weight:400; opacity:0.8;">天</span></p>
            </td>
            <td style="width:40%; padding:0 0 10px 0; text-align:center;">
                <p style="font-size:13px; color:rgba(255,255,255,0.8); margin:0 0 6px 0; line-height:1.4;">{phase_info['phase']}</p>
                <span style="font-size:12px; font-weight:600; background:rgba(255,255,255,0.2); padding:4px 12px; border-radius:99px;">{phase_info['focus']}</span>
            </td>
            <td style="width:30%; padding:0 0 10px 0; text-align:right;">
                <p style="font-size:13px; color:rgba(255,255,255,0.8); margin:0 0 4px 0; line-height:1.4;">每日目標</p>
                <p style="font-size:34px; font-weight:700; margin:0; line-height:1.1;">{phase_info['daily_target']} <span style="font-size:14px; font-weight:400; opacity:0.8;">題</span></p>
            </td>
        </tr>
    </table>
    <div style="background:rgba(255,255,255,0.2); border-radius:99px; height:4px; margin-top:4px;">
        <div style="width:{phase_info['progress_pct']}%; height:100%; background:rgba(255,255,255,0.85); border-radius:99px;"></div>
    </div>
</div>
""", unsafe_allow_html=True)
