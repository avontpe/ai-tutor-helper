...
<div style="background:#1e3a5f; color:white; padding:16px 20px; border-radius:8px; margin-bottom:14px;">
    <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:8px; margin-bottom:12px;">
        <div>
            <div style="font-size:13px; color:rgba(255,255,255,0.7); margin-bottom:4px;">距 {EXAM_YEAR} 學測</div>
            <div style="font-size:34px; font-weight:700; line-height:1;">{phase_info['days_left']} <span style="font-size:15px; font-weight:400; opacity:0.8;">天</span></div>
        </div>
        <div style="text-align:center;">
            <div style="font-size:13px; color:rgba(255,255,255,0.7); margin-bottom:4px;">{phase_info['phase']}</div>
            <div style="font-size:14px; font-weight:600; background:rgba(255,255,255,0.2); padding:4px 10px; border-radius:99px; display:inline-block;">{phase_info['focus']}</div>
        </div>
        <div style="text-align:right;">
            <div style="font-size:13px; color:rgba(255,255,255,0.7); margin-bottom:4px;">每日目標</div>
            <div style="font-size:34px; font-weight:700; line-height:1;">{phase_info['daily_target']} <span style="font-size:15px; font-weight:400; opacity:0.8;">題</span></div>
        </div>
    </div>
