...
st.markdown(f"""
<div style="background:#1e3a5f; color:white; padding:16px 20px; border-radius:8px; margin-bottom:14px;">
    <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:10px;">
        <div>
            <div style="font-size:12px; opacity:0.7; letter-spacing:0.5px; margin-bottom:2px;">距 {EXAM_YEAR} 學測</div>
            <div style="font-size:32px; font-weight:700; line-height:1; letter-spacing:-1px;">{phase_info['days_left']}<span style="font-size:16px; font-weight:400; opacity:0.8; margin-left:4px;">天</span></div>
        </div>
        <div style="text-align:center;">
            <div style="font-size:13px; font-weight:600; background:rgba(255,255,255,0.18); padding:5px 14px; border-radius:99px; margin-bottom:3px;">{phase_info['phase']}</div>
            <div style="font-size:12px; opacity:0.75;">{phase_info['focus']}</div>
        </div>
        <div style="text-align:right;">
            <div style="font-size:12px; opacity:0.7; letter-spacing:0.5px; margin-bottom:2px;">每日目標</div>
            <div style="font-size:32px; font-weight:700; line-height:1; letter-spacing:-1px;">{phase_info['daily_target']}<span style="font-size:16px; font-weight:400; opacity:0.8; margin-left:4px;">題</span></div>
        </div>
    </div>
