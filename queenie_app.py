...
<style>
    ...
    /* ── Radio 圓圈：加深選中與未選中顏色 ── */
    /* 未選中：深灰邊框 */
    [data-testid="stRadio"] input[type="radio"] + div > div:first-child {
        border-color: #6b7280 !important;
        border-width: 2px !important;
    }
    /* 選中：深藏青填色 */
    [data-testid="stRadio"] input[type="radio"]:checked + div > div:first-child {
        background-color: #1e3a5f !important;
        border-color: #1e3a5f !important;
    }
    /* 選中後的內圓點 */
    [data-testid="stRadio"] input[type="radio"]:checked + div > div:first-child > div {
