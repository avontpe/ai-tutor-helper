    ...
    if "quiz_state" not in st.session_state:
        ...
        if _row:
            try:
                ...
                st.session_state.quiz_state   = _draft.get("quiz_state", "setup")
                st.session_state.quiz_data    = _draft.get("quiz_data")
                st.session_state.user_answers = _draft.get("user_answers", {})
                ...
                st.session_state.quiz_start_time = _dt.datetime.now()
            except Exception:
