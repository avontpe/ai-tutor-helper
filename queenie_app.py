...
def check_app_password():
    ...
    <div class="login-wrap">
        <div class="login-hero">
            ...
            <div style="font-size:28px; font-weight:700; letter-spacing:-0.5px;">學測導航</div>
            <div style="font-size:15px; opacity:0.75; margin-top:6px;">116 學測備戰系統 · 請輸入密碼進入</div>
        </div>
        <div class="login-body">
            <div class="login-label">🔑 登入密碼</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
st.markdown(f"""
<div style="background:#1e3a5f; color:white; padding:18px 20px 12px; border-radius:8px; margin-bottom:14px;">
    <table style="width:100%; border-collapse:collapse; color:white;">
        <tr>
            <td style="width:33%; vertical-align:top; padding:0;">
                <div style="font-size:13px; color:rgba(255,255,255,0.75); padding-bottom:4px;">距 {EXAM_YEAR} 學測</div>
                <div style="font-size:36px; font-weight:700; line-height:1.1;">{phase_info['days_left']}<span style="font-size:16px; font-weight:400; margin-left:4px; opacity:0.85;">天</span></div>
            </td>
            <td style="width:34%; vertical-align:top; text-align:center; padding:0;">
                <div style="font-size:13px; color:rgba(255,255,255,0.75); padding-bottom:6px;">{phase_info['phase']}</div>
                <div style="font-size:13px; font-weight:600; background:rgba(255,255,255,0.2); padding:5px 12px; border-radius:99px; display:inline-block;">{phase_info['focus']}</div>
            </td>
            <td style="width:33%; vertical-align:top; text-align:right; padding:0;">
                <div style="font-size:13px; color:rgba(255,255,255,0.75); padding-bottom:4px;">每日目標</div>
                <div style="font-size:36px; font-weight:700; line-height:1.1;">{phase_info['daily_target']}<span style="font-size:16px; font-weight:400; margin-left:4px; opacity:0.85;">題</span></div>
            </td>
        </tr>
    </table>
    <div style="margin-top:12px; background:rgba(255,255,255,0.2); border-radius:99px; height:4px;">
